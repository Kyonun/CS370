...
{
      14,     0,    -1,    15,    -1,    -1,    16,    15,    -1,     3,
       5,     6,     8,    17,     7,    -1,    -1,    18,    17,    -1,
      19,    -1,     3,     5,    20,     6,     9,    -1,    21,    11,
      20,    -1,    21,    -1,    -1,     4,    -1,    22,    -1,    22,
      12,    22,    -1,    10,    -1
};
...
{
       0,    46,    46,    53,    56,    64,    73,    77,    87,    94,
     103,   111,   118,   122,   131,   136,   143
};
#endif
...
{
  "$end", "error", "$undefined", "ID", "STRING", "LPAREN", "RPAREN",
  "LBRACE", "RBRACE", "SEMICOLON", "NUMBER", "COMMA", "PLUS", "$accept",
  "Prog", "functions", "function", "statements", "statement", "funcall",
  "arguments", "argument", "expression", 0
};
#endif
...
{
      -2,    -3,     3,   -15,    -2,    -1,   -15,   -15,     0,     1,
       2,     4,     1,   -15,    -4,   -15,   -15,   -15,   -15,     6,
       5,     7,     8,    -4,    10,   -15,   -15,     7
};
...
{
      17,     1,     5,     6,    10,     8,    18,    14,     9,    26,
       0,    15,    22,     7,    27,     0,    23,    25,     0,    24,
      18,     0,     0,    16
};

static const yytype_int8 yycheck[] =
{
       4,     3,     5,     0,     3,     6,    10,     5,     8,    23,
      -1,     7,     6,     4,    24,    -1,    11,     9,    -1,    12,
      10,    -1,    -1,    12
};
...
{
       0,     3,    14,    15,    16,     5,     0,    15,     6,     8,
       3,    17,    18,    19,     5,     7,    17,     4,    10,    20,
      21,    22,     6,    11,    12,     9,    20,    22
};
