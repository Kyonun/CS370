...
{
       0,     0,     3,     5,     6,     9,    16,    17,    20,    22,
      28,    32,    34,    35,    37,    39,    43
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      16,     0,    -1,    17,    -1,    -1,    18,    17,    -1,     3,
       7,     8,    10,    19,     9,    -1,    -1,    20,    19,    -1,
      21,    -1,     3,     7,    22,     8,    11,    -1,    23,    13,
      22,    -1,    23,    -1,    -1,     4,    -1,    24,    -1,    24,
      14,    24,    -1,    12,    -1
};
...
{
       0,    54,    54,    62,    65,    73,    83,    87,    97,   104,
     113,   121,   128,   132,   141,   146,   153
};
#endif
...
{
  "$end", "error", "$undefined", "ID", "STRING", "KWINT", "KWCHAR",
  "LPAREN", "RPAREN", "LBRACE", "RBRACE", "SEMICOLON", "NUMBER", "COMMA",
  "PLUS", "$accept", "Prog", "functions", "function", "statements",
  "statement", "funcall", "arguments", "argument", "expression", 0
};
#endif
...
{
      -2,    -5,     3,   -12,    -2,    -3,   -12,   -12,    -6,     4,
      -1,     0,     4,   -12,    -4,   -12,   -12,   -12,   -12,     2,
       1,     5,     6,    -4,     8,   -12,   -12,     5
};
...
{
      17,     1,     5,     6,     9,     8,    14,    10,    18,    15,
      22,     7,    26,     0,    23,    27,     0,    25,     0,    24,
      18,    16
};

static const yytype_int8 yycheck[] =
{
       4,     3,     7,     0,    10,     8,     7,     3,    12,     9,
       8,     4,    23,    -1,    13,    24,    -1,    11,    -1,    14,
      12,    12
};
...
{
       0,     3,    16,    17,    18,     7,     0,    17,     8,    10,
       3,    19,    20,    21,     7,     9,    19,     4,    12,    22,
      23,    24,     8,    13,    14,    11,    22,    24
};
...
#line 66 "parser.y"
    {
			...
			strcat(code, (yyvsp[(1) - (2)].str));
			strcat(code, (yyvsp[(2) - (2)].str));
			(yyval.str) = code;
		}
    break;
...
#line 74 "parser.y"
    {
			...
			sprintf(coder,"\t.globl\t%s\n\t.type\t%s,@function\n%s:\n\tpushq\t%%rbp\nmovq\t%%rsp, %%rbp\n%s\n\tpopq\t%%rbp\n\tret\n" ,(yyvsp[(1) - (6)].str), (yyvsp[(1) - (6)].str), (yyvsp[(1) - (6)].str), (yyvsp[(5) - (6)].str));
...
#line 88 "parser.y"
    {
			...
			strcpy(stmtcat,(yyvsp[(1) - (2)].str));
			strcat(stmtcat,(yyvsp[(2) - (2)].str));
			(yyval.str) = stmtcat;
		}
    break;
...
#line 114 "parser.y"
    {
		char *code = (char*)malloc(sizeof(char)*1000);
		strcat(code, (yyvsp[(1) - (3)].str));
		strcat(code,(yyvsp[(3) - (3)].str));
		(yyval.str) = code;
		}
    break;
...
#line 133 "parser.y"
    {
			strungout.arrSize = addString((yyvsp[(1) - (1)].str));
			char *code = (char*)malloc(sizeof(char)*1000);
