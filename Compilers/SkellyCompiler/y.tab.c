...
{
      11,     0,    -1,    12,    -1,     3,     5,     6,     8,    13,
       7,    -1,    -1,    14,    13,    -1,    15,    -1,     3,     5,
       4,     6,     9,    -1
};
...
static const char *const yytname[] =
{
  ...
  "LBRACE", "RBRACE", "SEMICOLON", "$accept", "Prog", "function",
  "statements", "statement", "funcall", 0
};
#endif
...
#line 64 "parser.y"
    {
				char *stmtcat = malloc(sizeof(char)*(strlen((yyvsp[(1) - (2)].str))+strlen((yyvsp[(2) - (2)].str))+1));
...
#line 82 "parser.y"
    {
				...
				int sid = addString((yyvsp[(3) - (5)].str));
